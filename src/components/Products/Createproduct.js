...
function Createproduct() {
  ...
  const submithandler = (e) => {
    e.preventDefault();
    // console.log(name, image, price, description, Categories);
    dispatch(
      ...
      <div className="form">
        ...
        <form onSubmit={submithandler}>
          ...
          <Dropdown>
            ...
            <Dropdown.Menu>
              <Dropdown.Item onClick={() => setcategories("Electronic")}>
                Electronic
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setcategories("Furnitures")}>
                Furnitures
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setcategories("Clothing")}>
                Clothing
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setcategories("Accessories")}>
                Accessories
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
